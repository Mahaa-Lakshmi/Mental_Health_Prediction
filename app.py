...
def load_models():
    ...
    le = joblib.load('E:/AI engineer/Guvi/Capstone Projects/Project5/Mental_Health_Prediction/models/label_encoder.pkl')
    #knn_imputer = joblib.load('E:/AI engineer/Guvi/Capstone Projects/Project5/Mental_Health_Prediction/models/knn_imputer.pkl')
    scaler = joblib.load('E:/AI engineer/Guvi/Capstone Projects/Project5/Mental_Health_Prediction/models/scaler.pkl')
...
try:
    ...
    model = load_prediction_model(
        "E:/AI engineer/Guvi/Capstone Projects/Project5/Mental_Health_Prediction/models/prediction_model.pth",
